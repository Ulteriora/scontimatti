package it.ulteriora.scontimatti.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(it.ulteriora.scontimatti.application.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(it.ulteriora.scontimatti.application.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            ...
            cm.createCache(it.ulteriora.scontimatti.application.domain.Ordine.class.getName(), jcacheConfiguration);

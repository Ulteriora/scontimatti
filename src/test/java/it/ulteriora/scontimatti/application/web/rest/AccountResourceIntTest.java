...
import it.ulteriora.scontimatti.application.config.Constants;
import it.ulteriora.scontimatti.application.ScontimattiApp;
import it.ulteriora.scontimatti.application.domain.Authority;
import it.ulteriora.scontimatti.application.domain.User;
import it.ulteriora.scontimatti.application.repository.AuthorityRepository;
import it.ulteriora.scontimatti.application.repository.UserRepository;
import it.ulteriora.scontimatti.application.security.AuthoritiesConstants;
import it.ulteriora.scontimatti.application.service.MailService;
import it.ulteriora.scontimatti.application.service.dto.UserDTO;
import it.ulteriora.scontimatti.application.web.rest.errors.ExceptionTranslator;
import it.ulteriora.scontimatti.application.web.rest.vm.KeyAndPasswordVM;
import it.ulteriora.scontimatti.application.web.rest.vm.ManagedUserVM;
import it.ulteriora.scontimatti.application.service.UserService;

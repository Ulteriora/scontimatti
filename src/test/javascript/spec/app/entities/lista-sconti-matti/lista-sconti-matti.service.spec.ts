...
describe('Service Tests', () => {
    ...
    describe('ListaScontiMatti Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ListaScontiMattiService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/listas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return ListaScontiMatti', () => {
